...
MACRO(create_project mode defines includes links)
	...
	if( ${PROJECT_NAME}_SRC OR ${PROJECT_NAME}_HEADERS)
	...
	file(GLOB_RECURSE ${PROJECT_NAME}_HEADERS ${CMAKE_CURRENT_SOURCE_DIR}/*.h ${CMAKE_CURRENT_SOURCE_DIR}/*.hpp ${CMAKE_CURRENT_SOURCE_DIR}/*.inl ${CMAKE_CURRENT_SOURCE_DIR}/*.resx)
